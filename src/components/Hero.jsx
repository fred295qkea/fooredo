  ...
  return (
    <section className="grid w-full">
      ...
      <div className="grid col-start-1 col-end-1 row-start-1 row-end-1 place-content-center">
        <h1 className="mb-5 text-2xl text-white lg:text-6xl">Welcome to Foo Fest</h1>
        <div className="flex flex-row justify-center gap-5">
          <Link className="w-32 p-2 text-center text-white bg-accent" href="/program">
            PROGRAM
          </Link>
          <Link className="w-32 p-2 text-center text-white bg-accent" href="/map">
            MAP
          </Link>
        </div>
      </div>
