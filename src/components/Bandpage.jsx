...
export default function Bandpage({ singleviewData, scheduleData }) {
  ...
  return (
    <div className="grid gap-4 mx-4 my-8 text-white lg:w-2/5 lg:mx-auto">
      <div>
      ...
      <div className="flex flex-row items-center">
        <div className="flex items-center">{isUnsplashUrl ? <Image src={newBandUrl} alt={`${fusedData.name} logo`} width={300} height={300} className="object-cover imgcon" /> : <img src={newBandUrl} alt={`${fusedData.name} logo`} className="object-cover" />}</div>
        <div className="flex flex-col gap-6 ml-4 lg:flex-row ">
      ...
      <div className="m-4">
        {fusedData.cancelled ? (
          <p className="text-2xl text-center text-red-500">CANCELLED</p>
        ) : (
