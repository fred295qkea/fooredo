...
export default function Bandpage({ singleviewData, scheduleData }) {
  ...
  return (
    <div className="mx-4 pt-20 grid  gap-4 text-white md:w-2/5 md:mx-auto lg:w-2/5 lg:mx-auto">
      <div>
      ...
      <div className="flex flex-wrap mt-10">
        {fusedData.logoCredits ? (
          <p className="text-xxxxs">Photo {fusedData.logoCredits}</p>
        ) : (
          <p className="text-xs">No logo credits.</p>
        )}
      </div>
    </div>
  );
